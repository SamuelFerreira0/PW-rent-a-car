<div style="max-width: 760px; margin: 32px auto; padding: 0 16px; font-family: Arial, sans-serif; color: #1f2937;">
    <div style="display: flex; justify-content: space-between; align-items: center; gap: 12px; flex-wrap: wrap; margin-bottom: 20px;">
        <h1 style="margin: 0; font-size: 28px;">Novo Veiculo</h1>
    ...
    <form method="POST" action="/veiculos" style="background: #fff; border: 1px solid #e5e7eb; border-radius: 10px; padding: 18px; box-shadow: 0 1px 2px rgba(0,0,0,0.04);">
        @csrf

        <div style="margin-bottom: 14px;">
            <label for="matricula" style="display: block; margin-bottom: 6px; font-weight: 600;">Matricula</label>
            <input id="matricula" type="text" name="matricula" value="{{ old('matricula') }}" required style="width: 100%; padding: 10px; border: 1px solid #d1d5db; border-radius: 8px;">
        </div>

        <div style="margin-bottom: 14px;">
            <label for="marca" style="display: block; margin-bottom: 6px; font-weight: 600;">Marca</label>
            <input id="marca" type="text" name="marca" value="{{ old('marca') }}" required style="width: 100%; padding: 10px; border: 1px solid #d1d5db; border-radius: 8px;">
        </div>

        <div style="margin-bottom: 14px;">
            <label for="modelo" style="display: block; margin-bottom: 6px; font-weight: 600;">Modelo</label>
            <input id="modelo" type="text" name="modelo" value="{{ old('modelo') }}" required style="width: 100%; padding: 10px; border: 1px solid #d1d5db; border-radius: 8px;">
        </div>
        ...
        <div style="margin-bottom: 18px;">
            ...
            <input id="preco_diario" type="number" step="0.01" min="0.01" name="preco_diario" value="{{ old('preco_diario') }}" required style="width: 100%; padding: 10px; border: 1px solid #d1d5db; border-radius: 8px;">
        </div>
